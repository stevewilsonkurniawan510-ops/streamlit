...
export class WaveSurferPlayer implements PlaybackBackend {
  ...
  /**
   * Unmounts the visualizer without destroying the player.
   * This only hides the container visually but keeps the WaveSurfer instance alive
   * with the loaded audio intact. The player remains fully functional and can be
   * remounted by calling mountVisualizer() again.
   */
